...
export const JOB_DETAILS_REQUEST = 'JOB_LIST_REQUEST'
export const JOB_DETAILS_SUCCESS = 'JOB_LIST_SUCCESS'
export const JOB_DETAILS_FAIL = 'JOB_LIST_FAIL'
...
export const JOB_CREATE_REVIEW_REQUEST = 'JOB_CREATE_REVIEW_REQUEST'
export const JOB_CREATE_REVIEW_SUCCESS = 'JOB_CREATE_REVIEW_SUCCESS'
export const JOB_CREATE_REVIEW_FAIL = 'JOB_CREATE_REVIEW_FAIL'
export const JOB_CREATE_REVIEW_RESET = 'JOB_CREATE_REVIEW_RESET'
